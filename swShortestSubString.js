 ...
 * Find shortest substring containing all the desired characters.
...
function swShortestSubstring(inputString, characters) {
  ...
  for (
    ...
    windowEndIndex < inputString.length;
    windowEndIndex++
  ) {
    ...
    if (!missingCharCount) {
      ...
      while (
        ...
        (!(leftChar in neededCharCounts) || neededCharCounts[leftChar] < 0)
      ) {
      ...
      if (
        ...
        windowEndIndex - windowStartIndex <
          smallestWindowEndIndex - smallestWindowStartIndex
      ) {
...
const calculatedSolution1 = swShortestSubstring(
  exampleInput1,
  desiredCharacters1
);

console.log(
  `Example Input #1: ${exampleInput1}, Desired Characters: ${desiredCharacters1}, Solution: ${calculatedSolution1}`
);
...
const calculatedSolution2 = swShortestSubstring(
  exampleInput2,
  desiredCharacters2
);

console.log(
  `Example Input #2: ${exampleInput2}, Desired Characters: ${desiredCharacters2}, Solution: ${calculatedSolution2}`
);
...
const calculatedSolution3 = swShortestSubstring(
  exampleInput3,
  desiredCharacters3
);

console.log(
  `Example Input #3: ${exampleInput3}, Desired Characters: ${desiredCharacters3}, Solution: ${calculatedSolution3}`
);
...
const calculatedSolution4 = swShortestSubstring(
  exampleInput4,
  desiredCharacters4
);

console.log(
  `Example Input #4: ${exampleInput4}, Desired Characters: ${desiredCharacters4}, Solution: ${calculatedSolution4}`
);
